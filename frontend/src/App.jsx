...
export default function App() {
  ...
  const renderActiveView = () => {
    switch (activeView) {
      ...
      case 'recovery-assistant': return <SymptomLog backendUrl={backendUrl} geminiKey={geminiKey} lang={language}/>;
  ...
  if (!user) return <AuthScreen onAuth={(session) => setUser(session)} />;

  const handleLogout = () => { logout(); setUser(null); setActiveView('dashboard'); };
